...
export const translations: Record<string, Translation> = {
  ...
  tlh: {
    tagline: "yIja'be' neH {greeting} ja'chuqmeH jImej",
    phoneAnalogy: "yIqel: vay' DaqIp 'ej {greeting}! yIjatlh, 'ej ghaH DachIj... 🤦‍♀️",
    dontDoThis: "yIta'be'",
    insteadTryThis: "DaH yIta'",
    noteText: (receiverName) =>
      `yIlegh: Keith jangwI' Daj poH ret chaq Sam 'ej ${receiverName} cherghta'pu'be'. ${receiverName} qaSchugh, tlhob nID je!`,
    politenessText:
      "vay' vIghro'vam chenmoH: tlhob neH qaSbe', nuq 'ej qo'mey Hoch je - 'a 2025 DIS 'oH 'ej ja'chuqmeH jImej 'oHbe'. nuqDaq nuv, ghItlh jatlh jIH Hop law' jatlh puS. vaj Dochvam Suvvam, latlh nuv DachIj 'ej tlhob DaghItlh - 'ej Qu' Qatlh (qechvam je).",
    sameGoesFor: "rap:",
    areYouAround: "{greeting}, bIchegh'a'?",
    quickQuestion: "{greeting} sophie - tlhob tugh.",
    gotASec: "poH yIngu''a'?",
    justAskQuestion: "neH tlhob yIja'! 😫",
    ifBrusque: (greeting) =>
      `"{greeting}" yIjatlh 'ej tlhob yIja' qechvam bIQ Daj 'e' DapIH chugh, wejDIch ngevwI' yIlo'laH.`,
    forExample: "mIw:",
    exampleLong: (greeting) => `${greeting}! bIpIv 'e' vItul. De' chu' vIneH, poH yIl DaneHchugh :)`,
    exampleMedium: (greeting) => `${greeting}, nuq qaSpu'? 'ej, ghorgh mIS Daja'?`,
    exampleShort: (greeting) => `${greeting}, DuH SoHbe' chugh, NFRmey DachIjlaH'a'?`,
    asyncText: (greeting) =>
      `mach 'e' yIlegh, 'a jangwI' wa'DIch Daj qaSbe'DI' tlhob yIja' 'ej ja'chuqmeH jImej Qu' Qap. latlh nuv mej 'ej SoH DacheghDI', jang noblaH ghaH, "${greeting}" neH yIlegh 'ej nuq yIHemmeymo'.`,
    everyoneHappy: "qaS nIteb - Hoch belqu'! 🎉",
    halfSerious: "Qu'vam cha' vIHarbe' 😬 vaj yI",
    madLink: "QeHbe'",
    statusWarning: (greeting) =>
      `'a De' vam DaqIp URL vay' status/bio 'e' Dalo' chugh, bIghIjlu'taH chugh "${greeting}!" neH Dajatlh!`,
    createYourOwn: "DuH DachenmoH",
    openSource: "poSmoH malja'",
    anotherProject: "latlh",
    dumbProject: "Qu' Qagh",
    by: "chenmoHwI':",
    availableIn: "De' vam Hol:",
    enterGreeting: "ja'wI' DaqIp yIchIj:",
    generate: "yIchenmoH",
    advancedOptions: "DuH motlh",
    senderNameLabel: "ngaQHa'moHwI' pong (DuH)",
    senderNamePlaceholder: "mIw: Dawn",
    senderNameHelp: '"DaH yIta\'" mIwmey ja\'meH nuv',
    receiverNameLabel: "Qapla'wI' pong (DuH)",
    receiverNamePlaceholder: "mIw: Kuber",
    receiverNameHelp: "mIwmey Qapla'meH nuv",
    yourCustomLink: "lInk DuH:",
    previewPage: "De' DaH yIlegh →",
    tryPopular: "ja'wI'mey nIv yIwIv:",
    languageLabel: "Hol (DuH)",
    etc: "latlh.",
    chatWaiting: "...?",
    chatQuestion: "ghorgh mIS qaS?",
    chatAnswer: "oh - 3:30 jup",
    chatGreetingQuestion: (greeting) => `${greeting}! ghorgh mIS qaS?`,
    chatQuickAnswer: "nuqneH, 3:30",
    chatThanks: "qatlho' - qalegh!",
    chatAcknowledge: "👌 pagh",
  },
}
